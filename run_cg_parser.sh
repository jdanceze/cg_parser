...
python3 remove_std_lib_edges.py ./com.autostart.apk/output/labeled_cg.csv ./com.autostart.apk/output/methods_reference.txt combined_dataset.csv
python3 generate_extra_information_from_dataset.py ./test/ True