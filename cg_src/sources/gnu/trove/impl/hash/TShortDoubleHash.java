...
/* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/impl/hash/TShortDoubleHash.class */
public abstract class TShortDoubleHash extends TPrimitiveHash {
    ...
    public TShortDoubleHash() {
        ...
        this.no_entry_value = Const.default_value_double;
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public int insertKey(short val) {
