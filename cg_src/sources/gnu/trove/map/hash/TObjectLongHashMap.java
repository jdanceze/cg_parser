...
/* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap.class */
public class TObjectLongHashMap<K> extends TObjectHash<K> implements TObjectLongMap<K>, Externalizable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: gnu.trove.map.hash.TObjectLongHashMap.adjustOrPutValue(K, long, long):long, file: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap.class
    ...
    public long adjustOrPutValue(K r1, long r2, long r4) {
        /*
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: gnu.trove.map.hash.TObjectLongHashMap.adjustOrPutValue(K, long, long):long, file: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: gnu.trove.map.hash.TObjectLongHashMap.adjustOrPutValue(java.lang.Object, long, long):long");
    }
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap$KeyView.class */
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap$MapBackedView.class */
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap$TLongValueCollection.class */
    public class TLongValueCollection implements TLongCollection {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap$TLongValueCollection$TObjectLongValueHashIterator.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/hash/TObjectLongHashMap$TObjectLongHashIterator.class */
