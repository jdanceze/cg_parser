...
/* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap.class */
public class TObjectDoubleCustomHashMap<K> extends TCustomObjectHash<K> implements TObjectDoubleMap<K>, Externalizable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap.adjustOrPutValue(K, double, double):double, file: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap.class
    ...
    public double adjustOrPutValue(K r1, double r2, double r4) {
        /*
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap.adjustOrPutValue(K, double, double):double, file: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: gnu.trove.map.custom_hash.TObjectDoubleCustomHashMap.adjustOrPutValue(java.lang.Object, double, double):double");
    }
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap$KeyView.class */
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap$MapBackedView.class */
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap$TDoubleValueCollection.class */
    public class TDoubleValueCollection implements TDoubleCollection {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap$TDoubleValueCollection$TObjectDoubleValueHashIterator.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/map/custom_hash/TObjectDoubleCustomHashMap$TObjectDoubleHashIterator.class */
