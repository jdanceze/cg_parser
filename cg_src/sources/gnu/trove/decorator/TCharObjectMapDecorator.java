...
/* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/decorator/TCharObjectMapDecorator.class */
public class TCharObjectMapDecorator<V> extends AbstractMap<Character, V> implements Map<Character, V>, Externalizable, Cloneable {
    ...
    public /* bridge */ /* synthetic */ Object put(Character ch, Object x1) {
        return put2(ch, (Character) x1);
    }
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/decorator/TCharObjectMapDecorator$1.class */
        ...
        public Iterator<Map.Entry<Character, V>> iterator() {
            return new Iterator<Map.Entry<Character, V>>() { // from class: gnu.trove.decorator.TCharObjectMapDecorator.1.1
                ...
                public Map.Entry<Character, V> next() {
                    ...
                    return new Map.Entry<Character, V>() { // from class: gnu.trove.decorator.TCharObjectMapDecorator.1.1.1
                        private V val;
                        ...
                        public V setValue(V value) {
                            this.val = value;
                            return (V) TCharObjectMapDecorator.this.put2(key, (Character) value);
                        }
                    };
                }
    ...
    public boolean containsKey(Object key) {
        return key == null ? this._map.containsKey(this._map.getNoEntryKey()) : (key instanceof Character) && this._map.containsKey(((Character) key).charValue());
    }
    ...
    public void putAll(Map<? extends Character, ? extends V> map) {
        ...
        while (true) {
            ...
            if (i2 > 0) {
                ...
                put2(e.getKey(), (Character) e.getValue());
            } else {
                return;
            }
        }
