...
/* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/decorator/TDoubleShortMapDecorator.class */
public class TDoubleShortMapDecorator extends AbstractMap<Double, Short> implements Map<Double, Short>, Externalizable, Cloneable {
    ...
    /* loaded from: gencallgraphv3.jar:trove-3.0.3.jar:gnu/trove/decorator/TDoubleShortMapDecorator$1.class */
    public class AnonymousClass1 extends AbstractSet<Map.Entry<Double, Short>> {
        AnonymousClass1() {
        }
        ...
        public Iterator<Map.Entry<Double, Short>> iterator() {
            return new Iterator<Map.Entry<Double, Short>>() { // from class: gnu.trove.decorator.TDoubleShortMapDecorator.1.1
                ...
                public Map.Entry<Double, Short> next() {
                    ...
                    return new Map.Entry<Double, Short>() { // from class: gnu.trove.decorator.TDoubleShortMapDecorator.1.1.1
                        private Short val;
