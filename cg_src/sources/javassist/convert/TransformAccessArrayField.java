...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/convert/TransformAccessArrayField.class */
    ...
    private int replace(ConstPool cp, CodeIterator iterator, int pos, int opcode, String signature) throws BadBytecode {
        ...
        if (methodName != null) {
            if (opcode == 50) {
                ...
                if (TypeProxy.SilentConstruction.Appender.JAVA_LANG_OBJECT_INTERNAL_NAME.equals(castType)) {
                    castType = null;
                }
            }
