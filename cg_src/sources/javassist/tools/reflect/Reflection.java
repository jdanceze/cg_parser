...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/tools/reflect/Reflection.class */
public class Reflection implements Translator {
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        try {
            ...
            this.readParam = new CtClass[]{this.classPool.get(JavaBasicTypes.JAVA_LANG_OBJECT)};
    ...
    private void processFields(CtClass clazz) throws CannotCompileException, NotFoundException {
        ...
        for (CtField f : fs) {
            ...
            if ((mod & 1) != 0 && (mod & 16) == 0) {
                ...
                clazz.addMethod(wmethod);
                CtClass[] writeParam = {this.classPool.get(JavaBasicTypes.JAVA_LANG_OBJECT), ftype};
