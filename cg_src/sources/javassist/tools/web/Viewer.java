...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/tools/web/Viewer.class */
public class Viewer extends ClassLoader {
    ...
    protected byte[] fetchClass(String classname) throws Exception {
        byte[] b;
        URL url = new URL(HttpHost.DEFAULT_SCHEME_NAME, this.server, this.port, "/" + classname.replace('.', '/') + ".class");
