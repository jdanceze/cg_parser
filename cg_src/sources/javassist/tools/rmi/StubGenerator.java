...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/tools/rmi/StubGenerator.class */
public class StubGenerator implements Translator {
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        this.interfacesForProxy = pool.get(new String[]{JavaBasicTypes.JAVA_IO_SERIALIZABLE, "javassist.tools.rmi.Proxy"});
