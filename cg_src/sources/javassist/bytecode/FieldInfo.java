...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/FieldInfo.class */
public final class FieldInfo {
    ...
    public int getConstantValue() {
        ...
        if ((this.accessFlags & 8) == 0 || (attr = (ConstantAttribute) getAttribute("ConstantValue")) == null) {
            return 0;
        }
