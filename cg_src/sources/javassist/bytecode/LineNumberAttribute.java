...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/LineNumberAttribute.class */
public class LineNumberAttribute extends AttributeInfo {
    public static final String tag = "LineNumberTable";

    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/LineNumberAttribute$Pc.class */
