...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/BootstrapMethodsAttribute.class */
public class BootstrapMethodsAttribute extends AttributeInfo {
    public static final String tag = "BootstrapMethods";

    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/BootstrapMethodsAttribute$BootstrapMethod.class */
