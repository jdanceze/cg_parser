...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/MethodInfo.class */
public class MethodInfo {
    ...
    public String toString() {
        return getName() + Instruction.argsep + getDescriptor();
    }
    ...
    public boolean isMethod() {
        String n = getName();
        return (n.equals("<init>") || n.equals("<clinit>")) ? false : true;
    }
    ...
    public int getLineNumber(int pos) {
        ...
        CodeAttribute ca = getCodeAttribute();
        if (ca == null || (ainfo = (LineNumberAttribute) ca.getAttribute("LineNumberTable")) == null) {
            return -1;
        }
