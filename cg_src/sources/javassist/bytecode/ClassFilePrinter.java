...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/ClassFilePrinter.class */
public class ClassFilePrinter {
    ...
    public static void print(ClassFile cf, PrintWriter out) {
        ...
        for (FieldInfo finfo : fields) {
            ...
            out.println(Modifier.toString(AccessFlag.toModifier(acc)) + Instruction.argsep + finfo.getName() + "\t" + finfo.getDescriptor());
        ...
        for (MethodInfo minfo : methods) {
            ...
            out.println(Modifier.toString(AccessFlag.toModifier(acc2)) + Instruction.argsep + minfo.getName() + "\t" + minfo.getDescriptor());
