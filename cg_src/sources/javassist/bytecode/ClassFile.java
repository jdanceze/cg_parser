...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/ClassFile.class */
public final class ClassFile {
    ...
    private void initSuperclass(String superclass) {
        ...
        this.superClass = this.constPool.addClassInfo(JavaBasicTypes.JAVA_LANG_OBJECT);
        this.cachedSuperclass = JavaBasicTypes.JAVA_LANG_OBJECT;
    }
    ...
    public void setSuperclass(String superclass) throws CannotCompileException {
        if (superclass == null) {
            superclass = JavaBasicTypes.JAVA_LANG_OBJECT;
        }
        try {
            this.superClass = this.constPool.addClassInfo(superclass);
            for (MethodInfo minfo : this.methods) {
    ...
    public void write(DataOutputStream out) throws IOException {
        int n;
        out.writeInt(RuntimeConstants.JAVA_MAGIC);
