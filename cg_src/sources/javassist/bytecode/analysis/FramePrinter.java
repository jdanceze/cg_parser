...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/analysis/FramePrinter.class */
public final class FramePrinter {
    ...
    private String getMethodString(CtMethod method) {
        try {
            return Modifier.toString(method.getModifiers()) + Instruction.argsep + method.getReturnType().getName() + Instruction.argsep + method.getName() + Descriptor.toString(method.getSignature()) + ";";
