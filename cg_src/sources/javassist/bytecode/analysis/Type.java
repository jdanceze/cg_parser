...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/analysis/Type.class */
public class Type {
    ...
    public static final Type OBJECT = lookupType(JavaBasicTypes.JAVA_LANG_OBJECT);
    public static final Type SERIALIZABLE = lookupType(JavaBasicTypes.JAVA_IO_SERIALIZABLE);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean eq(CtClass one, CtClass two) {
    ...
    public String toString() {
        ...
        return this.clazz == null ? Jimple.NULL : this.clazz.getName();
    }
}
