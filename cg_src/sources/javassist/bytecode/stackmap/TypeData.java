...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData.class */
public abstract class TypeData {
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$BasicType.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$AbsTypeVar.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$TypeVar.class */
    ...
    public static CtClass commonSuperClassEx(CtClass one, CtClass two) throws NotFoundException {
        ...
        if (one.isArray() && two.isArray()) {
            ...
            return one.getClassPool().get(element == null ? JavaBasicTypes.JAVA_LANG_OBJECT : element.getName() + "[]");
        } else if (one.isPrimitive() || two.isPrimitive()) {
            return null;
        } else {
            if (one.isArray() || two.isArray()) {
                return one.getClassPool().get(JavaBasicTypes.JAVA_LANG_OBJECT);
            }
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$ArrayType.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$ArrayElement.class */
    public static class ArrayElement extends AbsTypeVar {
        ...
        public static String typeName(String arrayType) {
            if (arrayType.length() > 1 && arrayType.charAt(0) == '[') {
                ...
                return JavaBasicTypes.JAVA_LANG_OBJECT;
            }
            return JavaBasicTypes.JAVA_LANG_OBJECT;
        }
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$UninitTypeVar.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$ClassName.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$NullType.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$UninitData.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/stackmap/TypeData$UninitThis.class */
