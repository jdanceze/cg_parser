...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/bytecode/ParameterAnnotationsAttribute.class */
public class ParameterAnnotationsAttribute extends AttributeInfo {
    ...
    public String toString() {
        ...
        for (Annotation[] a : aa) {
            for (Annotation i : a) {
                sbuf.append(i.toString()).append(Instruction.argsep);
            }
            sbuf.append(", ");
        }
