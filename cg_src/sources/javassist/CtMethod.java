...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtMethod.class */
public final class CtMethod extends CtBehavior {
    ...
    public CtMethod(CtClass returnType, String mname, CtClass[] parameters, CtClass declaring) {
        ...
        setModifiers(InputDevice.SOURCE_GAMEPAD);
    }
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtMethod$ConstParameter.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtMethod$IntConstParameter.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtMethod$LongConstParameter.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtMethod$StringConstParameter.class */
