...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtClass.class */
public abstract class CtClass {
    ...
    public static CtClass booleanType = new CtPrimitiveType("boolean", 'Z', JavaBasicTypes.JAVA_LANG_BOOLEAN, "booleanValue", "()Z", 172, 4, 1);

    static {
        primitiveTypes[0] = booleanType;
        charType = new CtPrimitiveType("char", 'C', JavaBasicTypes.JAVA_LANG_CHARACTER, "charValue", "()C", 172, 5, 1);
        primitiveTypes[1] = charType;
        byteType = new CtPrimitiveType("byte", 'B', JavaBasicTypes.JAVA_LANG_BYTE, "byteValue", "()B", 172, 8, 1);
        primitiveTypes[2] = byteType;
        shortType = new CtPrimitiveType("short", 'S', JavaBasicTypes.JAVA_LANG_SHORT, "shortValue", "()S", 172, 9, 1);
        primitiveTypes[3] = shortType;
        intType = new CtPrimitiveType("int", 'I', JavaBasicTypes.JAVA_LANG_INTEGER, "intValue", "()I", 172, 10, 1);
        primitiveTypes[4] = intType;
        longType = new CtPrimitiveType("long", 'J', JavaBasicTypes.JAVA_LANG_LONG, "longValue", "()J", 173, 11, 2);
        primitiveTypes[5] = longType;
        floatType = new CtPrimitiveType(Jimple.FLOAT, 'F', JavaBasicTypes.JAVA_LANG_FLOAT, "floatValue", "()F", 174, 6, 1);
        primitiveTypes[6] = floatType;
        doubleType = new CtPrimitiveType("double", 'D', JavaBasicTypes.JAVA_LANG_DOUBLE, "doubleValue", "()D", 175, 7, 2);
        primitiveTypes[7] = doubleType;
        voidType = new CtPrimitiveType(Jimple.VOID, 'V', "java.lang.Void", null, null, 177, 0, 0);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtClass$DelayedFileOutputStream.class */
