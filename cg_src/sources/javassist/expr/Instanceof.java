...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/expr/Instanceof.class */
public class Instanceof extends Expr {
    ...
    public void replace(String statement) throws CannotCompileException {
        ...
        try {
            CtClass[] params = {cp.get(JavaBasicTypes.JAVA_LANG_OBJECT)};
            CtClass retType = CtClass.booleanType;
            int paramVar = ca.getMaxLocals();
            jc.recordParams(JavaBasicTypes.JAVA_LANG_OBJECT, params, true, paramVar, withinStatic());
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/expr/Instanceof$ProceedForInstanceof.class */
