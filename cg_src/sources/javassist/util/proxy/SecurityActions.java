...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/SecurityActions.class */
public class SecurityActions extends SecurityManager {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/SecurityActions$TheUnsafe.class */
