...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/RuntimeSupport.class */
public class RuntimeSupport {
    public static MethodHandler default_interceptor = new DefaultMethodHandler();

    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/RuntimeSupport$DefaultMethodHandler.class */
