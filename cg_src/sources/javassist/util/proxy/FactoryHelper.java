...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/FactoryHelper.class */
public class FactoryHelper {
    ...
    public static final String[] wrapperTypes = {JavaBasicTypes.JAVA_LANG_BOOLEAN, JavaBasicTypes.JAVA_LANG_BYTE, JavaBasicTypes.JAVA_LANG_CHARACTER, JavaBasicTypes.JAVA_LANG_SHORT, JavaBasicTypes.JAVA_LANG_INTEGER, JavaBasicTypes.JAVA_LANG_LONG, JavaBasicTypes.JAVA_LANG_FLOAT, JavaBasicTypes.JAVA_LANG_DOUBLE, "java.lang.Void"};
