...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/ProxyFactory.class */
public class ProxyFactory {
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/ProxyFactory$ClassLoaderProvider.class */
    public interface ClassLoaderProvider {
        ClassLoader get(ProxyFactory proxyFactory);
    }

    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/ProxyFactory$UniqueName.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/ProxyFactory$ProxyDetails.class */
    ...
    protected ClassLoader getClassLoader0() {
        ...
        if (this.superClass != null && !this.superClass.getName().equals(JavaBasicTypes.JAVA_LANG_OBJECT)) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/util/proxy/ProxyFactory$Find2MethodsArgs.class */
    ...
    private static void makeParameterList(Bytecode code, Class<?>[] params) {
        ...
        int n = params.length;
        code.addIconst(n);
        code.addAnewarray(TypeProxy.SilentConstruction.Appender.JAVA_LANG_OBJECT_INTERNAL_NAME);
        for (int i = 0; i < n; i++) {
            code.addOpcode(89);
            code.addIconst(i);
            Class<?> type = params[i];
