...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/CtArray.class */
public final class CtArray extends CtClass {
    ...
    public boolean subtypeOf(CtClass clazz) throws NotFoundException {
        ...
        if (cname.equals(JavaBasicTypes.JAVA_LANG_OBJECT)) {
            return true;
        }
    ...
    public CtClass getSuperclass() throws NotFoundException {
        return this.pool.get(JavaBasicTypes.JAVA_LANG_OBJECT);
    }
