...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/TypeChecker.class */
public class TypeChecker extends Visitor implements Opcode, TokenId {
    ...
    protected static StringBuffer typeToString(StringBuffer sbuf, int type, int dim, String cname) {
        ...
        if (type == 307) {
            ...
            try {
                ...
                s = TypeDescription.Generic.OfWildcardType.SYMBOL;
            }
        }
        sbuf.append(s);
        while (true) {
    ...
    public static ASTree getConstantFieldValue(CtField f) {
        ...
        if ((value instanceof Double) || (value instanceof Float)) {
            ...
            int token2 = value instanceof Long ? 403 : 402;
    ...
    public void atExpr(Expr expr) throws CompileError {
        ...
        if (token == 46) {
            ...
            if (member.equals(XMLConstants.LENGTH_ATTRIBUTE)) {
                try {
                    atArrayLength(expr);
    ...
    public void atArrayLength(Expr expr) throws CompileError {
        ...
        if (this.arrayDim == 0) {
            throw new NoFieldException(XMLConstants.LENGTH_ATTRIBUTE, expr);
        }
        this.exprType = 324;
        this.arrayDim = 0;
    }
