...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/MemberCodeGen.class */
public class MemberCodeGen extends CodeGen {
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/MemberCodeGen$JsrHook.class */
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/MemberCodeGen$JsrHook2.class */
        ...
        if (method instanceof Member) {
            ...
            if (op == 35) {
                ...
                if (classFollowedByDotSuper != null) {
                    ...
                    if (this.arrayDim > 0) {
                        targetClass = this.resolver.lookupClass(JavaBasicTypes.JAVA_LANG_OBJECT, true);
        ...
        if (expr instanceof Expr) {
            ...
            if (op == 35) {
                ...
                try {
                    ...
                    } else if (acceptLength && this.arrayDim > 0 && ((Symbol) e2.oprand2()).get().equals(XMLConstants.LENGTH_ATTRIBUTE)) {
                        return null;
                    } else {
                        badLvalue();
                    }
