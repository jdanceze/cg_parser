...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/Parser.class */
public final class Parser implements TokenId {
    ...
    */
    ...
    private ASTree parseDotClass(int builtinType, int dim) throws CompileError {
        ...
        switch (builtinType) {
            case 301:
                cname = JavaBasicTypes.JAVA_LANG_BOOLEAN;
                break;
            case 303:
                cname = JavaBasicTypes.JAVA_LANG_BYTE;
                break;
            case 306:
                cname = JavaBasicTypes.JAVA_LANG_CHARACTER;
                break;
            case 312:
                cname = JavaBasicTypes.JAVA_LANG_DOUBLE;
                break;
            case 317:
                cname = JavaBasicTypes.JAVA_LANG_FLOAT;
                break;
            case 324:
                cname = JavaBasicTypes.JAVA_LANG_INTEGER;
                break;
            case 326:
                cname = JavaBasicTypes.JAVA_LANG_LONG;
                break;
            case 334:
                cname = JavaBasicTypes.JAVA_LANG_SHORT;
                break;
