...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/TokenId.class */
public interface TokenId {
    ...
    public static final String[] opNames = {"!=", "%=", "&=", "*=", "+=", "-=", "/=", "<=", "==", ">=", "^=", "|=", "++", HelpFormatter.DEFAULT_LONG_OPT_PREFIX, "<<", "<<=", ">>", ">>=", "||", "&&", ">>>", ">>>="};
