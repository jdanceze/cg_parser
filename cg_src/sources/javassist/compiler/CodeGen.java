...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/CodeGen.class */
public abstract class CodeGen extends Visitor implements Opcode, TokenId {
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/CodeGen$ReturnHook.class */
    ...
    private boolean invalidDim(int srcType, int srcDim, String srcClass, int destType, int destDim, String destClass, boolean isCast) {
        ...
        if (isCast && srcDim == 0 && srcType == 307 && "java/lang/Object".equals(srcClass)) {
            return false;
        }
        return true;
    }
