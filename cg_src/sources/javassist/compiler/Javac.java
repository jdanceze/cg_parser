...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/Javac.class */
public class Javac {
    JvstCodeGen gen;
    SymbolTable stable;
    ...
    /* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/compiler/Javac$CtFieldWithInit.class */
