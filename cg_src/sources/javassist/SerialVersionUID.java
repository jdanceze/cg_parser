...
/* loaded from: gencallgraphv3.jar:javassist-3.28.0-GA.jar:javassist/SerialVersionUID.class */
public class SerialVersionUID {
    ...
    private static boolean isSerializable(CtClass clazz) throws NotFoundException {
        ...
        return clazz.subtypeOf(pool.get(JavaBasicTypes.JAVA_IO_SERIALIZABLE));
    }
