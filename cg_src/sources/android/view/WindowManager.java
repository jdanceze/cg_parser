...
/* loaded from: gencallgraphv3.jar:android-4.1.1.4.jar:android/view/WindowManager.class */
public interface WindowManager extends ViewManager {
    Display getDefaultDisplay();

    void removeViewImmediate(View view);

    /* loaded from: gencallgraphv3.jar:android-4.1.1.4.jar:android/view/WindowManager$BadTokenException.class */
    ...
    /* loaded from: gencallgraphv3.jar:android-4.1.1.4.jar:android/view/WindowManager$LayoutParams.class */
