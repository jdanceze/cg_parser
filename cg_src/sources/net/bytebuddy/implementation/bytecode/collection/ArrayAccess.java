...
/* loaded from: gencallgraphv3.jar:byte-buddy-1.10.15.jar:net/bytebuddy/implementation/bytecode/collection/ArrayAccess.class */
public enum ArrayAccess {
    ...
    public StackManipulation forEach(List<? extends StackManipulation> processInstructions) {
        ...
        for (StackManipulation processInstruction : processInstructions) {
            int i = index;
            index++;
            stackManipulations.add(new StackManipulation.Compound(Duplication.SINGLE, IntegerConstant.forValue(i), new Loader(), processInstruction));
        }
    ...
    /* loaded from: gencallgraphv3.jar:byte-buddy-1.10.15.jar:net/bytebuddy/implementation/bytecode/collection/ArrayAccess$Loader.class */
    public class Loader implements StackManipulation {
        ...
        public int hashCode() {
            return (17 * 31) + ArrayAccess.this.hashCode();
        }
    ...
    @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
    /* loaded from: gencallgraphv3.jar:byte-buddy-1.10.15.jar:net/bytebuddy/implementation/bytecode/collection/ArrayAccess$Putter.class */
