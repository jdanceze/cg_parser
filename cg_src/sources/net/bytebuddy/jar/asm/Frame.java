...
/* loaded from: gencallgraphv3.jar:byte-buddy-1.10.15.jar:net/bytebuddy/jar/asm/Frame.class */
class Frame {
            ...
            case 18:
                switch (argSymbol.tag) {
                    ...
                    case 6:
                        ...
                        return;
                    case 7:
                        push(8388608 | symbolTable.addType(TypeProxy.SilentConstruction.Appender.JAVA_LANG_CLASS_INTERNAL_NAME));
                        return;
                    case 8:
        ...
        if ((dstType & (-67108864)) != 0 || (dstType & KIND_MASK) == 8388608) {
            ...
            if ((srcType & (-4194304)) == (dstType & (-4194304))) {
                if ((dstType & KIND_MASK) == 8388608) {
                    ...
                    mergedType = mergedDim | 8388608 | symbolTable.addType(TypeProxy.SilentConstruction.Appender.JAVA_LANG_OBJECT_INTERNAL_NAME);
                }
                ...
                mergedType = Math.min(srcDim, dstDim) | 8388608 | symbolTable.addType(TypeProxy.SilentConstruction.Appender.JAVA_LANG_OBJECT_INTERNAL_NAME);
            } else {
                mergedType = 4194304;
            }
