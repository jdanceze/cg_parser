...
/* JADX WARN: Classes with same name are omitted:
  gencallgraphv3.jar:junit-4.13.2.jar:org/junit/runner/notification/RunNotifier.class
 */
/* loaded from: gencallgraphv3.jar:org.junit_4.13.2.v20211018-1956.jar:org/junit/runner/notification/RunNotifier.class */
public class RunNotifier {
    ...
    /* JADX WARN: Classes with same name are omitted:
      gencallgraphv3.jar:junit-4.13.2.jar:org/junit/runner/notification/RunNotifier$SafeNotifier.class
     */
    /* loaded from: gencallgraphv3.jar:org.junit_4.13.2.v20211018-1956.jar:org/junit/runner/notification/RunNotifier$SafeNotifier.class */
    public abstract class SafeNotifier {
        ...
        void run() {
            ...
            List<RunListener> safeListeners = new ArrayList<>(capacity);
            List<Failure> failures = new ArrayList<>(capacity);
    ...
    public void fireTestFailures(List<RunListener> listeners, final List<Failure> failures) {
        if (!failures.isEmpty()) {
            new SafeNotifier(listeners) { // from class: org.junit.runner.notification.RunNotifier.6
                @Override // org.junit.runner.notification.RunNotifier.SafeNotifier
