...
/* loaded from: gencallgraphv3.jar:objenesis-3.1.jar:org/objenesis/instantiator/sun/MagicInstantiator.class */
public class MagicInstantiator<T> implements ObjectInstantiator<T> {
    ...
    private byte[] writeExtendingClass(Class<?> type, String className) {
        ...
        try {
            ...
            in.writeByte(1);
            in.writeUTF(TypeProxy.SilentConstruction.Appender.NEW_INSTANCE_METHOD_NAME);
            in.writeByte(1);
            ...
            in.writeShort(15);
            in.writeByte(1);
            in.writeUTF(TypeProxy.SilentConstruction.Appender.JAVA_LANG_OBJECT_INTERNAL_NAME);
            in.writeByte(12);
            in.writeShort(3);
            in.writeShort(4);
            in.writeByte(7);
