...
/* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/bzip2/CBZip2OutputStream.class */
public class CBZip2OutputStream extends OutputStream implements BZip2Constants {
    ...
    private static final int[] INCS = {1, 4, 13, 40, 121, TokenId.LSHIFT, 1093, 3280, 9841, 29524, 88573, 265720, 797161, 2391484};
    private int last;
    ...
    protected static void hbMakeCodeLengths(char[] len, int[] freq, int alphaSize, int maxLen) {
        ...
        while (tooLong) {
            ...
            while (nHeap > 1) {
                ...
                int i4 = (weight_n1 & (-256)) + (weight_n2 & (-256));
                if ((weight_n1 & 255) > (weight_n2 & 255)) {
                    i = weight_n1 & 255;
                } else {
                    i = weight_n2 & 255;
                }
                weight[nNodes] = i4 | (1 + i);
                parent[nNodes] = -1;
                nHeap = nHeap3 + 1;
                heap[nHeap] = nNodes;
                int zz4 = nHeap;
    ...
    private void sendMTFValues() throws IOException {
        ...
        if (this.nMTF < 200) {
            ...
            i = this.nMTF < 1200 ? 4 : this.nMTF < 2400 ? 5 : 6;
        }
        int nGroups = i;
    ...
    /* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/bzip2/CBZip2OutputStream$Data.class */
