...
/* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/taskdefs/GenerateKey.class */
public class GenerateKey extends Task {
    ...
    /* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/taskdefs/GenerateKey$DnameParam.class */
    ...
    /* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/taskdefs/GenerateKey$DistinguishedName.class */
    public static class DistinguishedName {
        ...
        public String toString() {
            return (String) this.params.stream().map(p -> {
                return encode(p.getName()) + "=" + encode(p.getValue());
