...
/* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/taskdefs/compilers/Jvc.class */
public class Jvc extends DefaultCompilerAdapter {
    ...
    public boolean execute() throws BuildException {
        ...
        if (this.verbose) {
            cmd.createArgument().setValue(CCMReconfigure.FLAG_VERBOSE);
        }
