...
/* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/taskdefs/LoadProperties.class */
public class LoadProperties extends Task {
    ...
    public final void execute() throws BuildException {
        ...
        try {
            ChainReaderHelper.ChainReader instream = new ChainReaderHelper(getProject(), new InputStreamReader(new BufferedInputStream(this.src.getInputStream()), charset), this.filterChains).getAssembledReader();
