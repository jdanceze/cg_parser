...
/* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/types/selectors/AndSelector.class */
public class AndSelector extends BaseSelectorContainer {
    ...
    public boolean isSelected(File basedir, String filename, File file) {
        validate();
        return Stream.of((Object[]) getSelectors(getProject())).allMatch(s -> {
