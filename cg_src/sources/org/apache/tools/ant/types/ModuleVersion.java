...
/* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/types/ModuleVersion.class */
public class ModuleVersion {
    ...
    public String toString() {
        return getClass().getName() + "[number=" + this.number + ", preRelease=" + this.preRelease + ", build=" + this.build + "]";
    }
}
