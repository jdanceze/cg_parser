...
/* loaded from: gencallgraphv3.jar:ant-1.10.11.jar:org/apache/tools/ant/helper/AntXMLContext.class */
public class AntXMLContext {
    ...
    public void startPrefixMapping(String prefix, String uri) {
        List<String> list = this.prefixMapping.computeIfAbsent(prefix, k -> {
