...
/* loaded from: gencallgraphv3.jar:commons-io-2.7.jar:org/apache/commons/io/filefilter/FileFilterUtils.class */
public class FileFilterUtils {
    ...
    public static File[] filter(IOFileFilter filter, File... files) {
        ...
        return (File[]) acceptedFiles.toArray(FileUtils.EMPTY_FILE_ARRAY);
    }
