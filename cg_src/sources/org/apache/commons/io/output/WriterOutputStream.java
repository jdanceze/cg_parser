...
/* loaded from: gencallgraphv3.jar:commons-io-2.7.jar:org/apache/commons/io/output/WriterOutputStream.class */
public class WriterOutputStream extends OutputStream {
    ...
    public WriterOutputStream(Writer writer, Charset charset, int bufferSize, boolean writeImmediately) {
        this(writer, charset.newDecoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE).replaceWith(TypeDescription.Generic.OfWildcardType.SYMBOL), bufferSize, writeImmediately);
    }
