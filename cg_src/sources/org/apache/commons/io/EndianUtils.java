...
/* loaded from: gencallgraphv3.jar:commons-io-2.7.jar:org/apache/commons/io/EndianUtils.class */
public class EndianUtils {
    ...
    public static long readSwappedUnsignedInteger(byte[] data, int offset) {
        ...
        return (high << 24) + (ExpandableListView.PACKED_POSITION_VALUE_NULL & low);
    }
    ...
    public static long readSwappedLong(byte[] data, int offset) {
        ...
        return (high << 32) + (ExpandableListView.PACKED_POSITION_VALUE_NULL & low);
    }
