...
/* loaded from: gencallgraphv3.jar:commons-cli-1.2.jar:org/apache/commons/cli/Options.class */
public class Options implements Serializable {
    ...
    public Option getOption(String opt) {
        ...
        if (this.shortOpts.containsKey(opt2)) {
    ...
    public boolean hasOption(String opt) {
        String opt2 = Util.stripLeadingHyphens(opt);
        return this.shortOpts.containsKey(opt2) || this.longOpts.containsKey(opt2);
    }
