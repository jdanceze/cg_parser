...
/* loaded from: gencallgraphv3.jar:mockito-core-3.6.0.jar:org/mockito/internal/util/ObjectMethodsGuru.class */
public class ObjectMethodsGuru {
    ...
    public static boolean isToStringMethod(Method method) {
        ...
        return m.getReturnType() == String.class && m.getParameterTypes().length == 0 && "toString".equals(m.getName());
    }
