...
/* loaded from: gencallgraphv3.jar:asm-analysis-9.4.jar:org/objectweb/asm/tree/analysis/SimpleVerifier.class */
    ...
    public BasicValue merge(BasicValue value1, BasicValue value2) {
        if (!value1.equals(value2)) {
            ...
            if (type1 != null && ((type1.getSort() == 10 || type1.getSort() == 9) && type2 != null && (type2.getSort() == 10 || type2.getSort() == 9))) {
                ...
                return newArrayValue(Type.getObjectType(TypeProxy.SilentConstruction.Appender.JAVA_LANG_OBJECT_INTERNAL_NAME), numDimensions);
            }
            return BasicValue.UNINITIALIZED_VALUE;
        }
        return value1;
