...
/* loaded from: gencallgraphv3.jar:asm-commons-9.4.jar:org/objectweb/asm/commons/JSRInlinerAdapter.class */
public class JSRInlinerAdapter extends MethodNode implements Opcodes {
    ...
    public JSRInlinerAdapter(int api, MethodVisitor methodVisitor, int access, String name, String descriptor, String signature, String[] exceptions) {
    ...
    /* loaded from: gencallgraphv3.jar:asm-commons-9.4.jar:org/objectweb/asm/commons/JSRInlinerAdapter$Instantiation.class */
