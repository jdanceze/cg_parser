...
/* loaded from: gencallgraphv3.jar:asm-commons-9.4.jar:org/objectweb/asm/commons/Remapper.class */
public abstract class Remapper {
    ...
    public Object mapValue(Object value) {
        ...
        if (value instanceof Handle) {
            ...
            return new Handle(tag, mapType, mapMethodName, isFieldHandle ? mapDesc(handle.getDesc()) : mapMethodDesc(handle.getDesc()), handle.isInterface());
