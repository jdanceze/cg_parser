...
/* loaded from: gencallgraphv3.jar:asm-commons-9.4.jar:org/objectweb/asm/commons/AnalyzerAdapter.class */
public class AnalyzerAdapter extends MethodVisitor {
    ...
    private void pushDescriptor(String fieldOrMethodDescriptor) {
        ...
        if (fieldOrMethodDescriptor.charAt(0) == '(') {
            str = Type.getReturnType(fieldOrMethodDescriptor).getDescriptor();
        } else {
            str = fieldOrMethodDescriptor;
        }
