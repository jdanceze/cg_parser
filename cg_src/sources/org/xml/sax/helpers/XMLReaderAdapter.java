...
/* loaded from: gencallgraphv3.jar:xmlParserAPIs-2.6.2.jar:org/xml/sax/helpers/XMLReaderAdapter.class */
public class XMLReaderAdapter implements Parser, ContentHandler {
    ...
    /* loaded from: gencallgraphv3.jar:xmlParserAPIs-2.6.2.jar:org/xml/sax/helpers/XMLReaderAdapter$AttributesAdapter.class */
    ...
    private void setupXMLReader() throws SAXException {
        this.xmlReader.setFeature(Features.NAMESPACE_PREFIXES_FEATURE, true);
        try {
