...
@CheckReturnValue
/* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString.class */
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$ByteArrayCopier.class */
    public interface ByteArrayCopier {
        byte[] copyFrom(byte[] bArr, int i, int i2);
    }

    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$ByteIterator.class */
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$SystemByteArrayCopier.class */
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$ArraysByteArrayCopier.class */
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$AbstractByteIterator.class */
    ...
    public static ByteString readFrom(InputStream streamToDrain, int minChunkSize, int maxChunkSize) throws IOException {
        ...
        while (true) {
            ...
            if (chunk != null) {
                results.add(chunk);
                i = Math.min(chunkSize * 2, maxChunkSize);
            } else {
    ...
    private static ByteString readChunk(InputStream in, int chunkSize) throws IOException {
        ...
        while (true) {
            bytesRead = i;
            if (bytesRead >= chunkSize || (count = in.read(buf, bytesRead, chunkSize - bytesRead)) == -1) {
                break;
            }
            i = bytesRead + count;
        }
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$LeafByteString.class */
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$Output.class */
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$CodedBuilder.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$LiteralByteString.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/ByteString$BoundedByteString.class */
