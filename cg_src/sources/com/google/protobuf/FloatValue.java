...
/* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/FloatValue.class */
public final class FloatValue extends GeneratedMessageV3 implements FloatValueOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        return Float.floatToIntBits(getValue()) == Float.floatToIntBits(other.getValue()) && getUnknownFields().equals(other.getUnknownFields());
    }
    ...
    public int hashCode() {
        ...
        int hash2 = (29 * ((53 * ((37 * hash) + 1)) + Float.floatToIntBits(getValue()))) + getUnknownFields().hashCode();
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/FloatValue$Builder.class */
