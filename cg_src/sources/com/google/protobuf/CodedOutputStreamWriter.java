...
@CheckReturnValue
/* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/CodedOutputStreamWriter.class */
public final class CodedOutputStreamWriter implements Writer {
    ...
    private CodedOutputStreamWriter(CodedOutputStream output) {
        this.output = (CodedOutputStream) Internal.checkNotNull(output, MediaStore.EXTRA_OUTPUT);
