...
/* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/BoolValue.class */
public final class BoolValue extends GeneratedMessageV3 implements BoolValueOrBuilder {
    ...
    public int hashCode() {
        ...
        int hash2 = (29 * ((53 * ((37 * hash) + 1)) + Internal.hashBoolean(getValue()))) + getUnknownFields().hashCode();
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/BoolValue$Builder.class */
