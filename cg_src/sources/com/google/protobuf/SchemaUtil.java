...
@CheckReturnValue
/* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/SchemaUtil.class */
public final class SchemaUtil {
    ...
    public static int computeSizeStringList(int fieldNumber, List<?> list) {
        ...
        if (list instanceof LazyStringList) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                ...
                size = i2 + computeStringSizeNoTag2;
            }
        } else {
    ...
    static int computeSizeMessageList(int fieldNumber, List<?> list) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            size = i + computeMessageSizeNoTag;
        }
        return size;
    }
    ...
    public static boolean shouldUseTableSwitch(int lo, int hi, int numFields) {
        ...
        long lookupSpaceCost = 3 + (2 * numFields);
        long lookupTimeCost = 3 + numFields;
        return tableSpaceCost + (3 * 3) <= lookupSpaceCost + (3 * lookupTimeCost);
    }
