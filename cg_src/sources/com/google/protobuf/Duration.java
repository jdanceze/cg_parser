...
/* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/Duration.class */
public final class Duration extends GeneratedMessageV3 implements DurationOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        return getSeconds() == other.getSeconds() && getNanos() == other.getNanos() && getUnknownFields().equals(other.getUnknownFields());
    }
    ...
    public int hashCode() {
        ...
        int hash2 = (29 * ((53 * ((37 * ((53 * ((37 * hash) + 1)) + Internal.hashLong(getSeconds()))) + 2)) + getNanos())) + getUnknownFields().hashCode();
    ...
    /* loaded from: gencallgraphv3.jar:protobuf-java-3.21.7.jar:com/google/protobuf/Duration$Builder.class */
