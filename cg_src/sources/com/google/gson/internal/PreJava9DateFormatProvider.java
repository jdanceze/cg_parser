...
/* loaded from: gencallgraphv3.jar:gson-2.8.9.jar:com/google/gson/internal/PreJava9DateFormatProvider.class */
public class PreJava9DateFormatProvider {
    ...
    public static DateFormat getUSDateTimeFormat(int dateStyle, int timeStyle) {
        String pattern = getDatePartOfDateTimePattern(dateStyle) + Instruction.argsep + getTimePartOfDateTimePattern(timeStyle);
