...
/* loaded from: gencallgraphv3.jar:gson-2.8.9.jar:com/google/gson/internal/bind/JsonTreeReader.class */
public final class JsonTreeReader extends JsonReader {
    ...
    public void skipValue() throws IOException {
        if (peek() == JsonToken.NAME) {
            nextName();
            this.pathNames[this.stackSize - 2] = Jimple.NULL;
        } else {
            popStack();
            if (this.stackSize > 0) {
                this.pathNames[this.stackSize - 1] = Jimple.NULL;
            }
        }
        if (this.stackSize > 0) {
            int[] iArr = this.pathIndices;
