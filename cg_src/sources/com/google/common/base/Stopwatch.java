...
@GwtCompatible
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/base/Stopwatch.class */
public final class Stopwatch {
    ...
    public String toString() {
        ...
        return Platform.formatCompact4Digits(value) + Instruction.argsep + abbreviate(unit);
    }
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/base/Stopwatch$1.class */
