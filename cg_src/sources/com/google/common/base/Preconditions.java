...
@GwtCompatible
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/base/Preconditions.class */
public final class Preconditions {
    ...
    public static int checkElementIndex(int index, int size) {
        return checkElementIndex(index, size, XMLConstants.INDEX_ATTRIBUTE);
    }
    ...
    public static int checkPositionIndex(int index, int size) {
        return checkPositionIndex(index, size, XMLConstants.INDEX_ATTRIBUTE);
    }
