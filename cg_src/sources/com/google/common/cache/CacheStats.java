...
@GwtCompatible
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/cache/CacheStats.class */
public final class CacheStats {
    ...
    public double missRate() {
        long requestCount = requestCount();
        return requestCount == 0 ? Const.default_value_double : this.missCount / requestCount;
    }
    ...
    public double loadExceptionRate() {
        ...
        return totalLoadCount == 0 ? Const.default_value_double : this.loadExceptionCount / totalLoadCount;
    }
    ...
    public double averageLoadPenalty() {
        long totalLoadCount = this.loadSuccessCount + this.loadExceptionCount;
        return totalLoadCount == 0 ? Const.default_value_double : this.totalLoadTime / totalLoadCount;
    }
