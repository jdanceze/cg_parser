...
@GwtIncompatible
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/cache/Striped64.class */
abstract class Striped64 extends Number {
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/cache/Striped64$Cell.class */
    ...
    static {
        try {
            UNSAFE = getUnsafe();
            baseOffset = UNSAFE.objectFieldOffset(Striped64.class.getDeclaredField(XMLConstants.BASE_TAG));
