...
@Beta
@GwtIncompatible
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/TreeRangeSet.class */
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/TreeRangeSet$AsRanges.class */
    ...
    @VisibleForTesting
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/TreeRangeSet$RangesByUpperBound.class */
    public static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            final Iterator<Range<C>> it = backingItr;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/TreeRangeSet$ComplementRangesByLowerBound.class */
    public static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            final Cut<C> cut = firstComplementRangeLowerBound;
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            if (positiveItr.hasNext()) {
                if (positiveItr.peek().upperBound == Cut.aboveAll()) {
                    higherKey = positiveItr.next().lowerBound;
                } else {
                    higherKey = this.positiveRangesByLowerBound.higherKey(positiveItr.peek().upperBound);
                }
                cut = higherKey;
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/TreeRangeSet$Complement.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/TreeRangeSet$SubRangeSetRangesByLowerBound.class */
    public static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            final Iterator<Range<C>> it = completeRangeItr;
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/TreeRangeSet$SubRangeSet.class */
