...
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/ImmutableSortedSet.class */
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    public static <E> ImmutableSortedSet<E> construct(Comparator<? super E> comparator, int n, E... contents) {
        ...
        if (i3 < length) {
            objArr = Arrays.copyOf(contents, uniques);
        }
        return new RegularImmutableSortedSet(ImmutableList.asImmutableList(objArr, uniques), comparator);
    }
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/ImmutableSortedSet$Builder.class */
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/collect/ImmutableSortedSet$SerializedForm.class */
