...
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/math/BigIntegerMath.class */
public final class BigIntegerMath {
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/math/BigIntegerMath$1.class */
    ...
    public static int log10(BigInteger x, RoundingMode mode) {
        ...
        if (approxCmp > 0) {
            ...
            int compareTo = nextPow.compareTo(x);
            while (true) {
                int nextCmp = compareTo;
                if (nextCmp > 0) {
                    break;
                }
                approxLog10++;
