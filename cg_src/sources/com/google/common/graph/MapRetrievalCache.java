...
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/graph/MapRetrievalCache.class */
class MapRetrievalCache<K, V> extends MapIteratorCache<K, V> {
    ...
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/graph/MapRetrievalCache$CacheEntry.class */
