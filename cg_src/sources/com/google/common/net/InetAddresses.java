...
@Beta
@GwtIncompatible
/* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/net/InetAddresses.class */
public final class InetAddresses {
    ...
    private static byte parseOctet(String ipPart) {
        ...
        if (octet > 255 || (ipPart.startsWith(WorkException.UNDEFINED) && ipPart.length() > 1)) {
    ...
    @Beta
    /* loaded from: gencallgraphv3.jar:guava-27.1-android.jar:com/google/common/net/InetAddresses$TeredoInfo.class */
