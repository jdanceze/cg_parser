...
/* loaded from: gencallgraphv3.jar:cos.jar:com/oreilly/servlet/RemoteHttpServlet.class */
public abstract class RemoteHttpServlet extends HttpServlet implements Remote {
    ...
    protected void bind() {
        ...
        try {
            ...
            log(new StringBuffer().append("Could not bind to RMI registry: ").append(e3.getMessage()).toString());
        }
    }
