...
/* loaded from: gencallgraphv3.jar:functionaljava-4.2.jar:fj/data/fingertrees/Four.class */
public final class Four<V, A> extends Digit<V, A> {
    private final V4<A> as;

    /* JADX INFO: Access modifiers changed from: package-private */
    public Four(Measured<V, A> m, V4<A> as) {
        super(m);
        this.as = as;
    }
    ...
    public <B> B foldRight(F<A, F<B, B>> aff, B z) {
        return aff.f(this.as._1()).f(aff.f(this.as._2()).f(aff.f(this.as._3()).f(aff.f(this.as._4()).f(z))));
    }
