...
/* loaded from: gencallgraphv3.jar:soot/baf/Baf.class */
public class Baf {
    ...
    public LookupSwitchInst newLookupSwitchInst(Unit defaultTarget, List<IntConstant> lookupValues, List<? extends Unit> targets) {
    ...
    public static String bafDescriptorOf(Type type) {
        TypeSwitch<String> sw = new TypeSwitch<String>() { // from class: soot.baf.Baf.1
