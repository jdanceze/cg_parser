...
/* loaded from: gencallgraphv3.jar:soot/dotnet/instructions/CilLdTypeTokenInstruction.class */
public class CilLdTypeTokenInstruction extends AbstractCilnstruction {
    ...
    public Value jimplifyExpr(Body jb) {
        return DotnetClassConstant.v(this.instruction.getValueConstantString());
    }
}
