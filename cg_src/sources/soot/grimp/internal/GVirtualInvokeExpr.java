...
/* loaded from: gencallgraphv3.jar:soot/grimp/internal/GVirtualInvokeExpr.class */
public class GVirtualInvokeExpr extends AbstractVirtualInvokeExpr implements Precedence {
    ...
    public Object clone() {
        ...
        return new GVirtualInvokeExpr(Grimp.cloneIfNecessary(getBase()), this.methodRef, clonedArgs);
    }
}
