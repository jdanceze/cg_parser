...
/* loaded from: gencallgraphv3.jar:soot/grimp/internal/GSpecialInvokeExpr.class */
public class GSpecialInvokeExpr extends AbstractSpecialInvokeExpr implements Precedence {
    ...
    @Override // soot.jimple.internal.AbstractSpecialInvokeExpr
    ...
    @Override // soot.jimple.internal.AbstractSpecialInvokeExpr, soot.Value
    ...
    public Object clone() {
        ...
        return new GSpecialInvokeExpr(Grimp.cloneIfNecessary(getBase()), this.methodRef, clonedArgs);
    }
}
