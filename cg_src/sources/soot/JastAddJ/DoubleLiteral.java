...
/* loaded from: gencallgraphv3.jar:soot/JastAddJ/DoubleLiteral.class */
public class DoubleLiteral extends NumericLiteral implements Cloneable {
    ...
    public void typeCheck() {
        if (!isZero() && constant().doubleValue() == Const.default_value_double) {
    ...
    private Constant constant_compute() {
        try {
            ...
            Constant c = Constant.create((double) Const.default_value_double);
            c.error = true;
            return c;
        }
    }
