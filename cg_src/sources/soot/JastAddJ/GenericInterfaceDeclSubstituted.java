...
/* loaded from: gencallgraphv3.jar:soot/JastAddJ/GenericInterfaceDeclSubstituted.class */
public class GenericInterfaceDeclSubstituted extends GenericInterfaceDecl implements Cloneable, MemberSubstitutor {
    ...
    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.InterfaceDecl, soot.JastAddJ.ReferenceType, soot.JastAddJ.TypeDecl, soot.JastAddJ.ASTNode
    ...
    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.InterfaceDecl, soot.JastAddJ.ReferenceType, soot.JastAddJ.TypeDecl, soot.JastAddJ.ASTNode, beaver.Symbol
    ...
    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.InterfaceDecl, soot.JastAddJ.ASTNode
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    /* JADX WARN: Type inference failed for: r0v1, types: [soot.JastAddJ.ASTNode<soot.JastAddJ.ASTNode>, soot.JastAddJ.GenericInterfaceDeclSubstituted] */
    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.InterfaceDecl, soot.JastAddJ.ASTNode
    ...
    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.InterfaceDecl, soot.JastAddJ.ReferenceType, soot.JastAddJ.TypeDecl
    ...
    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.InterfaceDecl
    ...
    @Override // soot.JastAddJ.GenericInterfaceDecl
    public void setTypeParameterList(List<TypeVariable> list) {
        setChild(list, 2);
    }

    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.GenericTypeDecl
    ...
    public List<TypeVariable> getTypeParameterList() {
        List<TypeVariable> list = (List) getChild(2);
        list.getNumChild();
        return list;
    }
    ...
    @Override // soot.JastAddJ.GenericInterfaceDecl, soot.JastAddJ.InterfaceDecl, soot.JastAddJ.TypeDecl
