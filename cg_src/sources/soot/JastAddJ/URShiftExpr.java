...
import soot.Value;
/* loaded from: gencallgraphv3.jar:soot/JastAddJ/URShiftExpr.class */
public class URShiftExpr extends ShiftExpr implements Cloneable {
    ...
    @Override // soot.JastAddJ.ShiftExpr, soot.JastAddJ.Binary, soot.JastAddJ.Expr, soot.JastAddJ.ASTNode, beaver.Symbol
