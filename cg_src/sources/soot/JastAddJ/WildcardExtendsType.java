...
/* loaded from: gencallgraphv3.jar:soot/JastAddJ/WildcardExtendsType.class */
public class WildcardExtendsType extends AbstractWildcardType implements Cloneable {
    ...
    private boolean sameStructure_compute(TypeDecl t) {
        ...
        return (t instanceof WildcardExtendsType) && ((WildcardExtendsType) t).extendsType().sameStructure(extendsType());
    }
