...
/* loaded from: gencallgraphv3.jar:soot/jimple/parser/analysis/ReversedDepthFirstAdapter.class */
public class ReversedDepthFirstAdapter extends AnalysisAdapter {
    ...
    public void caseAFullMethodBody(AFullMethodBody node) {
        ...
        List<PDeclaration> copy3 = new ArrayList<>(node.getDeclaration());
        Collections.reverse(copy3);
        for (PDeclaration e3 : copy3) {
            e3.apply(this);
        }
        if (node.getLBrace() != null) {
            node.getLBrace().apply(this);
