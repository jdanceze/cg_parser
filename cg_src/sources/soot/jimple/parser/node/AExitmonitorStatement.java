...
/* loaded from: gencallgraphv3.jar:soot/jimple/parser/node/AExitmonitorStatement.class */
public final class AExitmonitorStatement extends PStatement {
    ...
    public Object clone() {
        return new AExitmonitorStatement((TExitmonitor) cloneNode(this._exitmonitor_), (PImmediate) cloneNode(this._immediate_), (TSemicolon) cloneNode(this._semicolon_));
    }
    ...
    public String toString() {
        return toString(this._exitmonitor_) + toString(this._immediate_) + toString(this._semicolon_);
    }
