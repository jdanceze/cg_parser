...
/* loaded from: gencallgraphv3.jar:soot/jimple/parser/node/ALookupswitchStatement.class */
public final class ALookupswitchStatement extends PStatement {
    ...
    public Object clone() {
        return new ALookupswitchStatement((TLookupswitch) cloneNode(this._lookupswitch_), (TLParen) cloneNode(this._lParen_), (PImmediate) cloneNode(this._immediate_), (TRParen) cloneNode(this._rParen_), (TLBrace) cloneNode(this._lBrace_), cloneList(this._caseStmt_), (TRBrace) cloneNode(this._rBrace_), (TSemicolon) cloneNode(this._semicolon_));
    }
    ...
    public String toString() {
        return toString(this._lookupswitch_) + toString(this._lParen_) + toString(this._immediate_) + toString(this._rParen_) + toString(this._lBrace_) + toString(this._caseStmt_) + toString(this._rBrace_) + toString(this._semicolon_);
    }
