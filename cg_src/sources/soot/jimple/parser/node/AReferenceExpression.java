...
/* loaded from: gencallgraphv3.jar:soot/jimple/parser/node/AReferenceExpression.class */
public final class AReferenceExpression extends PExpression {
    ...
    public Object clone() {
        return new AReferenceExpression((PReference) cloneNode(this._reference_));
    }
