...
/* loaded from: gencallgraphv3.jar:soot/jimple/spark/geom/heapinsE/HeapInsIntervalManager.class */
public class HeapInsIntervalManager extends IFigureManager {
    ...
    private SegmentNode[] header = new SegmentNode[3];
    ...
    public void mergeFigures(int upperSize) {
        ...
        if (this.size[2] > upperSize && this.header[2].is_new) {
            SegmentNode p = generate_many_to_all(this.header[2]);
            clean_garbage_many_to_all(p);
    ...
    */
    public void removeUselessSegments() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: soot.jimple.spark.geom.heapinsE.HeapInsIntervalManager.removeUselessSegments():void");
    }
    ...
    */
    private void clean_garbage_many_to_all(soot.jimple.spark.geom.dataRep.SegmentNode r7) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: soot.jimple.spark.geom.heapinsE.HeapInsIntervalManager.clean_garbage_many_to_all(soot.jimple.spark.geom.dataRep.SegmentNode):void");
    }
    ...
    */
    private void clean_garbage_all_to_many(soot.jimple.spark.geom.dataRep.SegmentNode r7) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: soot.jimple.spark.geom.heapinsE.HeapInsIntervalManager.clean_garbage_all_to_many(soot.jimple.spark.geom.dataRep.SegmentNode):void");
    }
