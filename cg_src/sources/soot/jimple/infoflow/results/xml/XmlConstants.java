...
/* loaded from: gencallgraphv3.jar:soot/jimple/infoflow/results/xml/XmlConstants.class */
class XmlConstants {
    XmlConstants() {
    }

    /* loaded from: gencallgraphv3.jar:soot/jimple/infoflow/results/xml/XmlConstants$Tags.class */
    class Tags {
    ...
    /* loaded from: gencallgraphv3.jar:soot/jimple/infoflow/results/xml/XmlConstants$Attributes.class */
    class Attributes {
    ...
    /* loaded from: gencallgraphv3.jar:soot/jimple/infoflow/results/xml/XmlConstants$Values.class */
    class Values {
