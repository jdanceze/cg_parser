...
/* loaded from: gencallgraphv3.jar:soot/jimple/infoflow/android/entryPointCreators/AndroidEntryPointConstants.class */
public class AndroidEntryPointConstants {
    ...
    private static final String[] activityMethods = {"void onCreate(android.os.Bundle)", "void onDestroy()", "void onPause()", ACTIVITY_ONRESTART, "void onResume()", "void onStart()", "void onStop()", "void onSaveInstanceState(android.os.Bundle)", ACTIVITY_ONRESTOREINSTANCESTATE, ACTIVITY_ONCREATEDESCRIPTION, ACTIVITY_ONPOSTCREATE, ACTIVITY_ONPOSTRESUME, ACTIVITY_ONATTACHFRAGMENT};
    ...
    private static final String[] serviceMethods = {"void onCreate()", "void onDestroy()", SERVICE_ONSTART1, SERVICE_ONSTART2, SERVICE_ONBIND, SERVICE_ONREBIND, SERVICE_ONUNBIND};
    ...
    private static final String[] fragmentMethods = {"void onCreate(android.os.Bundle)", "void onDestroy()", "void onPause()", FRAGMENT_ONATTACH, FRAGMENT_ONDESTROYVIEW, "void onResume()", "void onStart()", "void onStop()", FRAGMENT_ONCREATEVIEW, FRAGMENT_ONACTIVITYCREATED, FRAGMENT_ONVIEWSTATERESTORED, FRAGMENT_ONDETACH, "void onSaveInstanceState(android.os.Bundle)", FRAGMENT_ONVIEWCREATED};
    ...
    private static final String[] hostApduServiceMethods = {HOSTAPDUSERVICE_PROCESSCOMMANDAPDU, HOSTAPDUSERVICE_ONDEACTIVATED};
    ...
    private static final String[] contentproviderMethods = {CONTENTPROVIDER_ONCREATE, CONTENTPROVIDER_DELETE, CONTENTPROVIDER_GETTYPE, CONTENTPROVIDER_INSERT, CONTENTPROVIDER_QUERY, CONTENTPROVIDER_UPDATE};
    ...
    private static final String[] applicationMethods = {"void onCreate()", APPLICATION_ONTERMINATE};
    ...
    private static final String[] activityLifecycleMethods = {ACTIVITYLIFECYCLECALLBACK_ONACTIVITYSTARTED, ACTIVITYLIFECYCLECALLBACK_ONACTIVITYSTOPPED, ACTIVITYLIFECYCLECALLBACK_ONACTIVITYSAVEINSTANCESTATE, ACTIVITYLIFECYCLECALLBACK_ONACTIVITYRESUMED, ACTIVITYLIFECYCLECALLBACK_ONACTIVITYPAUSED, ACTIVITYLIFECYCLECALLBACK_ONACTIVITYDESTROYED, ACTIVITYLIFECYCLECALLBACK_ONACTIVITYCREATED};
    ...
    private static final String[] componentCallbackMethods = {COMPONENTCALLBACKS_ONCONFIGURATIONCHANGED, COMPONENTCALLBACKS_ONLOWMEMORY};
    ...
    public static boolean isLifecycleClass(String className) {
        return className.equals(ACTIVITYCLASS) || className.equals(SERVICECLASS) || className.equals(FRAGMENTCLASS) || className.equals(BROADCASTRECEIVERCLASS) || className.equals(CONTENTPROVIDERCLASS) || className.equals(APPLICATIONCLASS) || className.equals(APPCOMPATACTIVITYCLASS_V4) || className.equals(APPCOMPATACTIVITYCLASS_V7) || className.equals(APPCOMPATACTIVITYCLASS_X);
    }
    ...
    public static boolean isLifecycleSubsignature(String subsig) {
        return activityMethodList.contains(subsig) || serviceMethodList.contains(subsig) || fragmentMethodList.contains(subsig) || gcmIntentServiceMethodList.contains(subsig) || gcmListenerServiceMethodList.contains(subsig) || hostApduServiceMethodList.contains(subsig) || broadcastMethodList.contains(subsig) || contentProviderMethodList.contains(subsig) || applicationMethodList.contains(subsig) || activityLifecycleMethodList.contains(subsig) || componentCallbackMethodList.contains(subsig) || componentCallback2MethodList.contains(subsig) || serviceConnectionMethodList.contains(subsig);
    }
}
