...
/* loaded from: gencallgraphv3.jar:soot/jimple/infoflow/solver/fastSolver/InfoflowSolver.class */
public class InfoflowSolver extends IFDSSolver<Unit, Abstraction, BiDiInterproceduralCFG<Unit, SootMethod>> implements IInfoflowSolver {
    ...
    @Override // soot.jimple.infoflow.solver.fastSolver.IFDSSolver
    ...
    public boolean processEdge(PathEdge<Unit, Abstraction> edge) {
        propagate(edge.factAtSource(), edge.getTarget(), edge.factAtTarget(), null, false, IFDSSolver.ScheduleTarget.EXECUTOR);
        return true;
    }
