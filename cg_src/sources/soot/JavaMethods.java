package soot;
/* loaded from: gencallgraphv3.jar:soot/JavaMethods.class */
public class JavaMethods {
    ...
    public static final String THREADGROUP_UNCAUGHT_EXCEPTION = "<java.lang.ThreadGroup: void uncaughtException(java.lang.Thread,java.lang.Throwable)>";
    public static final String CLASSLOADER_INIT = "<java.lang.ClassLoader: void <init>()>";
    public static final String CLASSLOADER_LOAD_CLASS_INTERNAL = "<java.lang.ClassLoader: java.lang.Class loadClassInternal(java.lang.String)>";
    public static final String CLASSLOADER_CHECK_PACKAGE_ACC = "<java.lang.ClassLoader: void checkPackageAccess(java.lang.Class,java.security.ProtectionDomain)>";
    public static final String CLASSLOADER_ADD_CLASS = "<java.lang.ClassLoader: void addClass(java.lang.Class)>";
    public static final String CLASSLOADER_FIND_NATIVE = "<java.lang.ClassLoader: long findNative(java.lang.ClassLoader,java.lang.String)>";
    public static final String PRIV_ACTION_EXC_INIT = "<java.security.PrivilegedActionException: void <init>(java.lang.Exception)>";
    public static final String RUN_FINALIZE = "<java.lang.ref.Finalizer: void runFinalizer()>";
    public static final String THREAD_INIT_RUNNABLE = "<java.lang.Thread: void <init>(java.lang.ThreadGroup,java.lang.Runnable)>";
